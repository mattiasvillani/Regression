...
βhat = coef(fit)
Plots.abline!(βhat[2], βhat[1], color = colors[8], lw = 3, label = "vinter")
Plots.abline!(βhat[2], βhat[1], color = colors[8], lw = 3, label = "vår")
Plots.abline!(βhat[2], βhat[1], color = colors[8], lw = 3, label = "sommar")
Plots.abline!(βhat[2], βhat[1], color = colors[8], lw = 3, label = "höst")
